...
public class IpcAddDeviceActivity extends BaseActivity implements
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (what == 2) {
                ...
                device_mac.setText(code);
                device_name.setText("ipcam");
                device_psw.setText("默认为空");
            }
        }
                            ...
                            for (IpcDevice d : querylist) {
                                if (ipc.getDeviceid().equals(d.getDeviceid())) {
                                    ...
                                    Toast.makeText(IpcAddDeviceActivity.this,
                                            "该设备已存在", Toast.LENGTH_SHORT).show();
                                    // dialog.dismiss();
                                    return;
                                }
                            }
    ...
    public void onClick(View v) {
        ...
        if (id == wifi_search_device.getId()) {
                ...
                public void run() {
                    try {
                        ...
                        if (searchlist.size() != 0) {
                            ...
                            Looper.prepare();
                            Toast.makeText(IpcAddDeviceActivity.this,
                                    "没有搜到相关设备", Toast.LENGTH_SHORT).show();
                            Looper.loop();
                        }
            ...
            startActivityForResult(intent, Code_MSG);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode ==Code_MSG) {
            // 返回的图片信息
            String msg = data.getStringExtra("coderesult");
